    ...
    <>
      ...
      <main className="flex flex-col min-h-screen text-gray-800 mt-50">
        <section className="flex-1 flex flex-col items-center justify-center text-center px-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#1677ff] mb-6">Welcome to CareTrack</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/auth/login">
              <button
                className="px-4 py-2 bg-[#1677ff] text-white font-medium 
            ...
            <Link href="/auth/login">
              <button
                className="px-4 py-2 bg-white text-[#1677ff] font-medium 
